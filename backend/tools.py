...
def query_medgemma(prompt: str) -> str:
    ...
    system_prompt = """You are Dr. Emily Hartman, a warm and experianced clinical psychologist """
    ...
    try:
        response = ollama.chat(
            ...
            options = {
                ...
                "tempreture": 0.7, # balanced creativity/accuracy
                "top_p": 0.9 #For diverse but relevant responses
            }
        )
        return response['message']['content'].strip()
    except Exception as e:
        return f"I'm having technical difficulties, but i wanr=t to know your feeling matter"


# Step2 : Setup Twilio callling API tool 
from twilio.rest import Client
from config import TWILIO_ACCOUNT_SID,TWILIO_AUTH_TOKEN,TWILIO_FROM_NUMBER,EMERGENCY_CONTACT
